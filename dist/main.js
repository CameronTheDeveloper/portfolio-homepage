...
.about-me-section {
    display: grid;
    grid-template-rows: 1fr 7fr 11fr;
...
}`, "",{"version":3,"sources":["webpack://./src/styles/header.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,mCAAmC;AACvC;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,kBAAkB;IAClB,aAAa;AACjB;;AAEA,mBAAmB;;AAEnB;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,sBAAsB;AAC1B;;AAEA;IACI,YAAY;IACZ,eAAe;AACnB;;AAEA,qBAAqB;;AAErB;IACI,aAAa;IACb,gCAAgC;IAChC,oCAAoC;IACpC,+BAA+B;IAC/B,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;IAClB,kBAAkB;IAClB,aAAa;AACjB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,oBAAoB;AACxB;;AAEA;IACI,gBAAgB;IAChB,gBAAgB;IAChB,mBAAmB;IACnB;AACJ;;AAEA,mBAAmB;;AAEnB;IACI,gBAAgB;IAChB,mBAAmB;IACnB,YAAY;IACZ,cAAc;IACd,wBAAwB;AAC5B","sourcesContent":["header {\n    display: grid;\n    grid-template-rows: 1fr 2fr 8fr 1fr;\n}\n\n.header-title {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    text-align: center;\n    padding: 1rem;\n}\n\n/* self-portrait1 */\n\nheader .self-portrait1-container {\n    display: flex;\n    justify-content: center;\n    margin-bottom: 1rem;\n    padding: 1rem 0 1rem 0;\n}\n\nheader .self-portrait1-container img {\n    height: auto;\n    max-width: 100%;\n}\n\n/* about-me-section */\n\n.about-me-section {\n    display: grid;\n    grid-template-rows: 1fr 7fr 11fr;\n    background-color: rgb(219, 219, 219);\n    border: 2px dashed rgb(0, 0, 0);\n    border-radius: 50px;\n}\n\n.about-me-section .title {\n    text-align: center;\n    place-self: center;\n    padding: 1rem;\n}\n\n.about-me-section .body {\n    padding: 1rem;\n}\n\n.about-me-section .image-container {\n    display: flex;\n    flex-direction: column;\n    justify-content: end;\n}\n\n.about-me-section .image-container img {\n    object-fit: fill;\n    margin-top: 1rem;\n    border-radius: 50px;\n    border: 1px solid rgb(74, 209, 83)\n}\n\n/* hire-me-button */\n\n.hire-me-button {\n    padding: 1.25rem;\n    border-radius: 50px;\n    margin: 4rem;\n    font-size: 2em;\n    border: 2px double black;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
main .link-icons-container a .new-tab-indicator {
    font-size: 2rem;
}
...
main .position .position-headlines {
    display: grid;
...
main .position .position-dates .start-date {
    justify-self: end;
}
...
main .position .position-dates .end-date {
    justify-self: start;
}

main .position .position-dates .dash {
    margin: 0 1rem 0 1rem;
}`, "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,gCAAgC;IAChC,aAAa;IACb,qBAAqB;IACrB,sBAAsB;AAC1B;;AAEA;IACI,qBAAqB;AACzB;;AAEA,eAAe;;AAEf;IACI,aAAa;IACb,8BAA8B;IAC9B,qBAAqB;IACrB,kBAAkB;IAClB,8BAA8B;IAC9B,eAAe;AACnB;;AAEA;IACI,YAAY;IACZ,YAAY;IACZ,6BAA6B;IAC7B,YAAY;IACZ,kBAAkB;IAClB,qBAAqB;AACzB;;AAEA;IACI,sCAAsC;AAC1C;;AAEA;IACI,eAAe;AACnB;;AAEA,aAAa;AACb;IACI,aAAa;IACb,4BAA4B;IAC5B,qBAAqB;AACzB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,mCAAmC;IACnC,qBAAqB;IACrB,8BAA8B;IAC9B,qBAAqB;IACrB,aAAa;IACb,mBAAmB;IACnB,oCAAoC;AACxC;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,YAAY;IACZ,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,YAAY;AAChB;;AAEA,cAAc;;AAEd;IACI,aAAa;IACb,qBAAqB;IACrB,4BAA4B;IAC5B,qBAAqB;AACzB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,2BAA2B;IAC3B,8BAA8B;IAC9B,mCAAmC;IACnC,aAAa;IACb,qBAAqB;IACrB,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,kCAAkC;AACtC;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,kCAAkC;IAClC,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,oBAAoB;AACxB;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,qBAAqB;AACzB","sourcesContent":["main {\n    display: grid;\n    grid-template-rows: 1fr 15fr 5fr;\n    padding: 1rem;\n    justify-items: center;\n    background-color: grey;\n}\n\nmain .main-header {\n    margin: 1rem 0 7rem 0;\n}\n\n/* link icons */\n\nmain .main-header .link-icons-container {\n    display: grid;\n    justify-content: space-between;\n    justify-items: center;\n    text-align: center;\n    grid-template-columns: 1fr 1fr;\n    padding: 1.5rem;\n}\n\nmain .link-icons-container a {\n    width: 12rem;\n    margin: 1rem;\n    background-color: transparent;\n    border: none;\n    border-radius: 15%;\n    text-decoration: none;\n}\n\nmain .link-icons-container a:hover {\n    background-color: rgba(5, 5, 5, 0.267);\n}\n\nmain .link-icons-container a .new-tab-indicator {\n    font-size: 2rem;\n}\n\n/* Web Apps */\nmain .apps-section {\n    display: grid;\n    grid-template-rows: 1fr 50fr;\n    justify-items: center;\n}\n\nmain .apps-section .apps-container {\n    display: grid;\n}\n\nmain .apps-container .web-app-card {\n    display: grid;\n    grid-template-rows: 2fr 3fr 5fr 3fr;\n    justify-items: center;\n    border: 1px solid rgb(0, 0, 0);\n    margin: 1rem 0 7rem 0;\n    padding: 1rem;\n    border-radius: 16px;\n    background-color: rgb(255, 255, 255);\n}\n\nmain .web-app-card .app-title {\n    padding: 0.2rem;\n}\n\nmain .web-app-card .button-container {\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n}\n\nmain .web-app-card .button-container button {\n    width: 20rem;\n    margin: 1rem;\n    border-radius: 10%;\n}\n\nmain .web-app-card .button-container button img {\n    width: 10rem;\n}\n\n/* Positions */\n\nmain .positions-section {\n    display: grid;\n    justify-items: center;\n    grid-template-rows: 1fr 25fr;\n    margin: 3rem 0 1rem 0;\n}\n\nmain .positions-section .positions-container {\n    display: grid;\n}\n\nmain .positions-container .position {\n    display: grid;\n    grid-template-rows: 4fr 5fr;\n    border: 1px solid rgb(0, 0, 0);\n    background-color: rgb(115, 255, 90);\n    padding: 1rem;\n    margin: 1rem 0 7rem 0;\n    border-radius: 8px;\n}\n\nmain .position .position-headlines {\n    display: grid;\n    grid-template-rows: repeat(4, 1fr);\n}\n\nmain .position .position-title {\n    text-align: center;\n}\n\nmain .position .company-name {\n    text-align: center;\n}\n\nmain .position .position-dates {\n    display: grid;\n    grid-template-columns: 2fr 1fr 2fr;\n    justify-content: center;\n    align-items: center;\n}\n\nmain .position .position-dates .start-date {\n    justify-self: end;\n}\n\nmain .position .position-dates .dash {\n    justify-self: center;\n}\n\nmain .position .position-dates .end-date {\n    justify-self: start;\n}\n\nmain .position .position-dates .dash {\n    margin: 0 1rem 0 1rem;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
