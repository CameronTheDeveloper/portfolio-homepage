...
main .positions-container .position {
    display: grid;
    align-items: center;
    grid-template-rows: repeat(4, 2fr) 5fr;
    border: 1px solid rgb(0, 0, 0);
