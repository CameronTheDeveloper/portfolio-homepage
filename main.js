...
___CSS_LOADER_EXPORT___.push([module.id, `main {
    display: grid;
    grid-template-rows: 1fr 1fr 16fr 7fr;
    padding: 1rem;
...
main .experience-links-container {
    display: grid;
